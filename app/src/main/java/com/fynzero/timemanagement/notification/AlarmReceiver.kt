package com.fynzero.timemanagement.notification
...
import com.fynzero.timemanagement.view.activity.SplashScreenActivity
import java.util.*
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(context: Context) {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setLargeIcon(BitmapFactory.decodeResource(context.resources, R.drawable.stopwatch))
